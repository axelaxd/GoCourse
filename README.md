...
1. [Слайсы и map](./week-02/slices-maps.md)
2. [Интерфейсы](./week-03/interfaces.md)
3. [defer, panic и recover](./week-04/defer-panic-recover.md)
4. [Горутины, каналы и select](./week-06/goroutines-channels-select.md)
5. [context, Mutex и WaitGroup](./week-07/context-sync.md)
6. [HTTP Handler и middleware](./week-11/http-middleware.md)
7. [Table-driven tests и httptest](./week-12/table-tests-httptest.md)
